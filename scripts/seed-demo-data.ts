...
const POLITIQUE_ARTICLES: DemoArticle[] = [
  {
    ...
    excerpt: "Après trois ans de guerre totale, des contacts discrets ont repris entre Kiev et Moscou. Analyse des conditions, des acteurs et de ce que chaque camp peut accepter.",
...
La vraie question : un cessez-le-feu sans accord politique est-il stable ? Tous les précédents depuis 1945 suggèrent que non.`,
  ...
  },
  {
    ...
    excerpt: "L'indice annuel de Freedom House dresse un tableau sombre : pour la 19e année consécutive, les libertés reculent dans le monde. Mais les mécanismes ont changé.",
...
Ce qui résiste : les démocraties où le pouvoir judiciaire reste indépendant et où la société civile est dense. La Pologne en est l'exemple inverse réussi : l'érosion sous PiS a été partiellement renversée par une alternance électorale, ce qui montre que le processus n'est pas irréversible.`,
  ...
  },
  {
    ...
    excerpt: "Après vingt ans d'investissements massifs, la relation sino-africaine entre dans une phase de renégociation. Les États africains reprennent la main - avec des succès inégaux.",
...
Ce qui ne change pas : Pékin conserve un avantage décisif sur les financements d'infrastructure. Les États-Unis et l'Europe ne proposent toujours pas d'alternative crédible à l'échelle et à la rapidité d'exécution des entreprises chinoises.`,
  ...
  },
  {
    ...
    excerpt: "63% d'abstention au premier tour. Derrière le chiffre brut, une analyse fine des territoires montre que le désengagement n'est pas uniforme - et que ses causes non plus.",
...
La vraie question politique : est-ce que les partis adaptent leur offre en conséquence, ou continuent-ils à optimiser pour l'électorat qui vote ?`,
  ...
  },
  {
    ...
    site_name: "Le Monde",
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "Sans Mbappé, sans Neymar, le PSG atteint le dernier carré européen avec un collectif que personne n'attendait. L'analyse d'une métamorphose.",
    content_text: "Après les années faste des stars galactiques, le PSG version 2025 incarne un modèle différent...",
    word_count: 145,
  ...
  },
  {
    ...
    site_name: "Voici",
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "On vous dit tout sur l'accrochage qui a fait jaser tout le festival. Les révélations exclusives d'un proche.",
...
const CUISINE_ARTICLES: DemoArticle[] = [
  {
    ...
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "Les accords mets-sans-alcool sont passés du geste charitable au vrai travail de cave. Dans les grandes maisons, le mocktail est mort - le jus vivant l'a remplacé.",
...
À suivre : le travail de Margot Lecarpentier au Dauphin, qui explore les fermentations de fleurs sauvages comme accord avec la cuisine végétale.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "La fermentation lactique est la technique la plus sûre et la plus reproductible pour transformer n'importe quel légume. Voici comment maîtriser les variables qui font la différence.",
...
Ce qui change tout : fermenter des légumes de saison à leur pic. Un chou fermenté en octobre avec une tête de pleine saison n'a rien à voir avec ce qu'on obtient avec un chou de serre en mars. La lacto-fermentation amplifie la qualité du produit de base, elle ne la remplace pas.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "La cheffe triplement étoilée revient sur vingt ans à la tête de la maison Pic - et sur ce que transmettre une cuisine signifie vraiment quand on a construit quelque chose d'unique.",
...
Ce qui la préoccupe aujourd'hui : "La disparition des petits producteurs. On peut faire toute la cuisine du monde qu'on veut, si les semences paysannes disparaissent et qu'il ne reste que deux ou trois variétés de tomates industrielles, on a perdu quelque chose d'irremplaçable."`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 4 * 86400000).toISOString(),
    excerpt: "On sait l'utiliser sur une sole meunière ou une madeleine. Mais le beurre noisette peut transformer des plats auxquels on ne l'associe jamais - légumes rôtis, vinaigrettes, glaces.",
...
Le risque principal : aller trop loin. Entre beurre noisette et beurre brûlé, il y a trente secondes. La couleur cible est celle d'une noisette décortiquée, l'arôme doit être de noisette torréfiée - pas d'amer.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "La correction amorcée en 2023 se poursuit dans la capitale, avec des baisses atteignant 12% dans certains arrondissements. Les acheteurs reprennent la main.",
    content_text: "Après des années de hausse ininterrompue, le marché immobilier parisien connaît une correction...",
    word_count: 130,
    reading_time_minutes: 1,
    score: 17,
    justification: "Article hors profil",
...
const TECH_ARTICLES: DemoArticle[] = [
  {
    ...
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "TypeScript 5.5 ships two long-requested features: type-safe capture groups from regex patterns, and inferred type predicates from return type analysis.",
...
Both features reduce the ceremony of type-safe code in common patterns. The release also includes performance improvements to the type checker that reduce incremental build times by 10-15% on large projects.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "React 19 est officiellement stable. Les trois grandes nouveautés : Actions pour les transitions async, Server Components stables, et le React Compiler en opt-in.",
...
Le React Compiler s'intègre en opt-in. Il analyse statiquement vos composants et élimine le besoin de useMemo et useCallback dans la plupart des cas. Les résultats sur le codebase de Meta sont significatifs.`,
  ...
  },
  {
    ...
    site_name: "Lobsters",
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "Après des années de burnouts et de librairies critiques abandonnées, certains modèles de financement open source ont enfin assez de recul pour être évalués.",
...
Ce qui ne fonctionne toujours pas : l'hypothèse que les entreprises qui dépendent de l'open source vont volontairement le financer à grande échelle. Ça n'a pas eu lieu, ça n'a pas lieu, et ça n'aura probablement pas lieu sans changement structurel.`,
  ...
  },
  {
    ...
    site_name: "TLDR",
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "Node.js 22 entre en LTS. Vite 6 sort avec Rolldown (bundler Rust, 3-5x plus rapide). Deno Deploy ajoute les cron jobs edge. GitHub Copilot ouvre les PRs en mode agent.",
...
GitHub Copilot mode agent (preview) peut maintenant ouvrir des PRs, lancer des tests, et itérer sur la base des retours CI sans intervention humaine.`,
  ...
  },
  {
    ...
    site_name: "L'Équipe",
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "Victoire 3-1 face à l'Atletico. Le PSG retrouve le dernier carré européen pour la première fois depuis 2021.",
    content_text: "Le Paris Saint-Germain s'est qualifié pour les demi-finales de la Ligue des Champions...",
    word_count: 110,
    reading_time_minutes: 1,
    score: 38,
    justification: "Article hors profil - serendipité",
  ...
  },
  {
    ...
    site_name: "aufeminin",
    published_at: new Date(Date.now() - 4 * 86400000).toISOString(),
    excerpt: "Du crochet au total look beige, voici tout ce qu'il faut avoir dans son dressing cet été selon les défilés.",
    content_text: "L'été 2025 s'annonce coloré et textured selon les tendances venues des podiums...",
    word_count: 105,
    reading_time_minutes: 1,
    score: 13,
    justification: "Article hors profil",
...
const SPORT_ARTICLES: DemoArticle[] = [
  {
    ...
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "La majorité des blessures en course à pied surviennent non pas par manque d'effort, mais par progression trop rapide. Ce plan intègre les données récentes sur la gestion de la charge.",
...
Intégrez deux séances de 20 minutes de gainage par semaine dès la première semaine. C'est l'investissement le plus rentable pour arriver à la ligne de départ en bonne santé.`,
  ...
  },
  {
    ...
    site_name: "So Foot",
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "Être 'dans la zone', c'est un état neurologique précis. La recherche a maintenant assez de données pour comprendre comment y accéder - et comment le sport de haut niveau peut en apprendre au commun des mortels.",
...
Application pratique pour le sportif amateur : identifier les 5-10 minutes qui précèdent votre meilleure performance et les ritualisir. Même musique, même ordre d'échauffement, même séquence mentale. La cohérence crée la prévisibilité de l'état.`,
  ...
  },
  {
    ...
    site_name: "L'Équipe",
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "Alcaraz-Sinner, l'affiche rêvée en finale ? Analyse du tableau, des conditions de jeu et des possibilités de surprises dans les premiers tours.",
...
Les conditions : le clay parisien a été retravaillé après les critiques de 2023 sur des rebonds irréguliers. La surface devrait être plus rapide que les deux dernières éditions.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 4 * 86400000).toISOString(),
    excerpt: "La fenêtre anabolique de 30 minutes post-effort est un mythe marketing. La réalité de la synthèse protéique est plus nuancée - et plus favorable aux sportifs qui ne comptent pas leurs grammes.",
...
Les sources : whey, caséine, protéines végétales - toutes fonctionnent si l'apport total est suffisant. L'obsession pour la whey est un artefact marketing plus que scientifique. Pour un sportif qui mange équilibré, les compléments protéinés sont rarement nécessaires.`,
  ...
  },
  {
    ...
    site_name: "L'Équipe",
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "Le tracé dévoilé ce jeudi favorise clairement les grimpeurs avec 5 arrivées au sommet en altitude. Analyse du parcours et des forces en présence.",
    content_text: "Le parcours du Tour de France 2025 avec ses cinq arrivées au sommet va favoriser les grimpeurs purs...",
    word_count: 125,
    reading_time_minutes: 1,
    score: 44,
    justification: "Article hors profil - serendipité",
  ...
  },
  {
    ...
    site_name: "BFM TV",
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "L'indice parisien a clôturé à 8.742 points, son plus haut niveau historique, tiré par LVMH et Hermès.",
...
const CULTURE_ARTICLES: DemoArticle[] = [
  {
    ...
    title: "Le nouveau cinéma africain s'impose sur les grands festivals - et bouscule les récits dominants",
    author: "Cécile Mury",
    site_name: "Télérama",
    published_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    excerpt: "De Cannes à Sundance, les films d'Afrique subsaharienne trustent les sélections officielles. Pas parce que c'est la mode - parce que la qualité est là, et les thèmes aussi.",
...
À voir absolument : "La Cour des miracles" de Maïmouna Doucouré (Mali/France), et "Eko Atlantic" du Nigérian Tunde Kelani, deux films qui seront en salles françaises cet automne.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 2 * 86400000).toISOString(),
    excerpt: "Alors que des romans générés automatiquement inondent l'autoédition, une partie de la littérature contemporaine mise sur l'expérience incarnée, la durée et la vulnérabilité.",
...
Quelques noms à suivre dans la rentrée littéraire : Kaoutar Harchi, dont le nouveau roman travaille la langue comme matière politique, et Tiago Rodrigues, dont le premier roman prolonge son travail de metteur en scène sur la mémoire collective.`,
  ...
  },
  {
    ...
    title: "La musique électronique française retrouve une identité - et ce n'est pas celle de Daft Punk",
    author: "Johanna Seban",
    site_name: "Les Inrockuptibles",
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "Après des années sous l'ombre de l'âge d'or, une nouvelle génération de producteurs français construit quelque chose de genuinement différent - avec des racines dans le club africain, le gqom et la cumbia.",
...
Le lieu qui cristallise tout ça : le Glazart à Paris, qui a construit une programmation internationale avec cette identité depuis 2022.`,
  ...
  },
  {
    ...
    title: "La solitude des jeunes adultes n'est pas un problème de téléphone - c'est un problème d'infrastructure",
    author: "Marie Kirschen",
    site_name: "Slate.fr",
    published_at: new Date(Date.now() - 4 * 86400000).toISOString(),
    excerpt: "Les données de santé publique sont claires : les 25-35 ans sont la tranche d'âge la plus solitaire. Blâmer les réseaux sociaux est confortable. C'est aussi inexact.",
...
La solution n'est pas individuelle - "sortez, éteignez vos téléphones" - elle est politique : financer les tiers-lieux, rendre les villes plus habitables, construire l'infrastructure de la rencontre.`,
  ...
  },
  {
    ...
    published_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    excerpt: "On a testé pendant 3 mois les produits dont tout le monde parle sur TikTok. Verdict honnête.",
    content_text: "Après trois mois de test intensif des sérums vitamine C, acides et SPF recommandés partout...",
    word_count: 105,
    reading_time_minutes: 1,
    score: 19,
    justification: "Article hors profil",
